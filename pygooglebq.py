...
config = {
	...
	"target_table" : "e-observer-396621.bgdataset.bgtable6",
	"numPartitions" : 4,
	"partitioncolm" :"in_date",
	"target_partition_size": None,
	"concat_field1":"Country",
	"concat_field2":"Number_of_employees"
}
...
def main(file_format,file_name,load_partition,schema):
	...
	input_df = input_df.withColumn("concat_column",fc.struct(fc.concat(fc.col(config['concat_field1']),fc.col(config['concat_field2'])).alias("concat_field"),fc.lit("").alias("concat_value")))
	input_df.show(5)
